...
export function WalletSelector() {
  ...
  const { multiTokenCount, recentTransactionCount } = useGetAccountData();
      ...
      <DropdownMenuContent align="end">
        ...
        {multiTokenCount > 0 && (
          <DropdownMenuItem className="gap-2 text-muted-foreground" disabled>
            <span className="h-4 w-4 flex items-center justify-center text-xs bg-blue-100 text-blue-800 rounded-full">
              {multiTokenCount}
            </span>
            {multiTokenCount === 1 ? "1 token" : `${multiTokenCount} tokens`}
          </DropdownMenuItem>
        )}
        {recentTransactionCount > 0 && (
          <DropdownMenuItem className="gap-2 text-muted-foreground" disabled>
            <span className="h-4 w-4 flex items-center justify-center text-xs bg-green-100 text-green-800 rounded-full">
